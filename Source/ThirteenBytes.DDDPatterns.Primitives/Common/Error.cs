namespace ThirteenBytes.DDDPatterns.Primitives.Common
{
    ...
    public record Error(string Code, string Description)
    {
        ...
        public static Error NotFound(string domainModelName) =>
        ...
        public static Error InternalError(string description) =>
            new("InternalError", description);
